...
// import TrainingTable from './TrainingTable'; // Adjust the import path as needed
...
const epochs = [
  ...
  const epochDurations = [
    44, // Example: 20 seconds for Epoch 0
    55, // Example: 20 seconds for Epoch 1
    35, // Example: 20 seconds for Epoch 2
    33  // Example: 20 seconds for Epoch 3
  ];
...
<div style={{marginLeft:"250px" , marginTop:"20px"}}> <img src='/img/LearningRateofResnet50.png' style={{width:"120%"}} /></div>
            }
        </div>
